...
The following diagram shows the current planned/tested hardware connections. The external display connection is not included because it has not been tested.

![MicroByte wiring diagram](diagram.jpg)
